...
cdf1 <- read_csv(here::here("classification", "20250721_125504_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label))
cdf2 <- read_csv(here::here("classification", "20250721_125532_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label))
cdf3 <- read_csv(here::here("classification", "20250721_125758_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label))
cdf4 <- read_csv(here::here("classification", "20250721_125837_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label)) |>
...
cdf5 <- read_csv(here::here("classification", "20250721_145256_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label)) |>
  mutate(predicted_label=ifelse(predicted_label=="meritocrat - does not mention the margin", "meritocrat - does not mention margin", predicted_label))
cdf6 <- read_csv(here::here("classification", "20250721_155742_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label))
cdf7 <- read_csv(here::here("classification", "20250724_111737_classified_motivations.csv")) |> mutate(predicted_label = strip_stars_quotes(predicted_label))
```
...
```{r}
read_and_combine_motivation_csvs <- function(path = here::here("classification")) {
...
tar_load(tvariants_table)
tvariants <- tvariants_table |>
  gt::gt() |>
  tab_spanner(label="With training data", columns=2:3) |>
  tab_spanner(label="Without training data", columns=4:5) |>
  fmt_number(decimals = 3)
tvariants
gtsave(tvariants, filename=here::here("tables", "tvariants.tex"))
```
