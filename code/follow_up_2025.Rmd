...
cdta <- mmw2025 |> left_join(classified_motivations) |>
  mutate( all_to_winner = as.numeric(y2==e2),
          ...
          lib_nomargin = as.numeric( predicted_label %in% c("libertarian","meritocrat - does not mention margin")),
          margin_matters = as.numeric(predicted_label %in% c("meritocrat - does mention the margin"))) 
